import {
  type ColorSchemePlugin,
  createColorSchemePlugin,
} from "@bob-obringer/tw-color-schemes";
import {
  mauveDark,
  skyDark,
  rubyDark,
...
export const colorSchemePlugin: ColorSchemePlugin = createColorSchemePlugin({
  background: {
