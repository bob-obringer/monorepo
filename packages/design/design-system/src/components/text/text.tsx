...
const textVariants = tv({
  variants: {
    variant: {
      ...
      "title-expanded-large": "typography-title-expanded-large",
      "title-expanded-medium": "typography-title-expanded-medium",
      "title-expanded-small": "typography-title-expanded-small",
